...
const Home = () => {
    ...
    const generateResponse = async () => {
        ...
        if (isConfigured) {
            const response = await fetch(
                `http://127.0.0.1:8000/stream-llm-?api_key=${configuration['api_key']}&model_backbone=${configuration['model_backbone']}`,
                {
                    method: "POST",
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <div
                className="mt-12 flex h-12 items-center justify-center rounded-lg border border-slate-300 md:w-11/12 xl:w-7/12 xl:min-w-[1000px]">
            ...
            {/* ------------ Configuration Options Starts ------------ */}
            {configureMenu ? (
                <ConfigureMenu setIsConfigured={setIsConfigured} configuration={configuration} setConfiguration={setConfiguration}/>
            ) : null}
            {/* ------------ JOBS Grid Starts ------------ */}
            <div
                ref={gridRef}
            ...
            <div
                className="my-16 flex w-full flex-wrap items-center justify-around gap-8 px-8 md:w-11/12 lg:p-0 xl:w-10/12">
