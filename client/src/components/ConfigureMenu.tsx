...
interface ConfigureMenuProps {
    ...
    configuration: {[index: string]: string|number},
    setConfiguration: Dispatch<SetStateAction<{
...
const ConfigureMenu = ({setIsConfigured, configuration, setConfiguration}: ConfigureMenuProps) => {
    ...
    const handleConfigChange = (field: string, value: string | number) => {
        ...
        const prevConfig = configuration
        prevConfig[field] = value
    };
    ...
    return (
        ...
        >
            <div
                className="flex flex-col gap-6 rounded-lg border-2 border-slate-200 p-4 md:w-11/12 xl:w-7/12 xl:min-w-[1000px]">
